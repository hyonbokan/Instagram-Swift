...
class ListViewController: UIViewController {
    ...
    //the custom initializer init(data:) is used to provide the ListViewController class with the required data for display. It assigns the passed data to the instance's data property and initializes the superclass using the designated initializer.
