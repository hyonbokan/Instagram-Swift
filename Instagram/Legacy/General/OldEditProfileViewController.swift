...
final class OldEditProfileViewController: UIViewController, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        view.addSubview(tableView) // Don't forget to add tableView in subviews
    ...
    // The tableView will not be shown without this
    ...
    @objc private func didTapChangeProfilePicture() {
        ...
        // PopoverPresentationController is included to avoid app crashing on iPad
...
extension OldEditProfileViewController: FormTableViewCellDelegate {
