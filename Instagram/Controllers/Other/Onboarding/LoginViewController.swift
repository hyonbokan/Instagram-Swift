...
class LoginViewController: UIViewController {
    // private keyword is an access control modifier. It restricts the visibility of the property to within the same source file where it is defined.
    ...
    override func viewDidLayoutSubviews() {
        // assign frames
        //view.width is a custom extension instead of view.frame.size.width
